...
data class RNMLKitFaceDetectorOptionsRecord(
...
class RNMLKitFaceDetectorOptions(
    ...
    constructor(record: RNMLKitFaceDetectorOptionsRecord) : this(
    ...
    val record: RNMLKitFaceDetectorOptionsRecord
        get() {
