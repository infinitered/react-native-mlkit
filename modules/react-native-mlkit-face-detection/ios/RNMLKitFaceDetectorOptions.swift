//
//  RNMLKitFaceDetectorOptions.swift
...
public struct RNMLKitFaceDetectorOptionsRecord: Record {
...
public class RNMLKitFaceDetectorOptions {
    ...
    convenience init(record: RNMLKitFaceDetectorOptionsRecord) {
        self.init(
    ...
    var record: RNMLKitFaceDetectorOptionsRecord {
        let record = RNMLKitFaceDetectorOptionsRecord()
