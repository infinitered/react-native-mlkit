...
class ExpoMLKitObjectDetectionModule : ExpoMLKitModule("ExpoMLKitObjDet") {

    private val objectDetectorMap = ExpoMLKitObjectDetectorMap()
    private var defaultDetector: ExpoMLKitDefaultObjectDetector? = null
    ...
    override fun definition() = ModuleDefinition {
        ...
        AsyncFunction("loadCustomModel") { spec: ExpoMLKitObjectDetectorSpec, promise: Promise ->
        ...
        AsyncFunction("loadDefaultModel") { options: ExpoMLKitObjectDetectorOptions?, promise: Promise ->
            ...
            try {
                defaultDetector = defaultDetector ?: ExpoMLKitDefaultObjectDetector(options)
        ...
        AsyncFunction("detectObjects") { modelName: String, imagePath: String, promise: Promise ->
            ...
            runBlocking suspend@{
                val objectDetector: ExpoMLKitObjectDetector? =
