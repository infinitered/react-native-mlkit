...
public class ExpoMLKitImageLabelingModule: Module {
    let ERROR_DOMAIN: String = "red.infinite.ExpoMLKit.ExpoMLKitImageLabelingModuleErrorDomain";
    ...
    public func definition() -> ModuleDefinition {
        ...
        AsyncFunction("addModel") { (spec: ExpoMLKitImageLabelerSpec, promise: Promise) in
            ...
            do{
                ...
                logger.info("ExpoMLKit", "addModel: model loaded successfully!")
        ...
        AsyncFunction("classifyImage") { (modelName:String, imagePath:String, promise:Promise) in
            let logger = Logger()
            logger.info("ExpoMLKit", "classify image: Classifying image: \(imagePath) ")
            ...
            Task {
                do {
                    ...
                    logger.info("ExpoMLKit", "classify image: Image classification successful")
